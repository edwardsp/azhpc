...
cd /mnt/resource/scratch/ansys/INSTALLERS
...
cat <<EOF > /mnt/resource/scratch/ansys/applications/ansys_inc/shared_files/licensing/ansyslmd.ini
SERVER=1055@$LICIP
...
export PATH=/mnt/resource/scratch/ansys/applications/ansys_inc/v172/fluent/bin:\$PATH
EOF
