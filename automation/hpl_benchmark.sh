...
function run_benchmark() {
    ...
    execute "run_linpack" ssh hpcuser@${public_ip} "cd hpl && mpirun -np $mpiRanks -ppn 2 -hostfile ../bin/hostlist ./xhpl_intel64_static -n $fullLinpack_N -p $fullLinpack_P -q $fullLinpack_Q -nb $fullLinpack_NB"
