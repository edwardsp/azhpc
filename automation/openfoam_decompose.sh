...
function run_benchmark {
    ...
    execute "download_case" ssh hpcuser@${public_ip} "cd /mnt/resource/scratch && wget https://$storageAccountName.blob.core.windows.net/$storageContainerName/$storageBenchmarkPath/$storageBenchmarkName.tar -O - | tar xv"
